        ...
        for (const msg of latestByUser.values()) {
            ...
            try {
                ...
                for (const checkMsg of allMsgs.values()) {
                    // Check if this is a bot message that replied to our message
...
- AFK Mode: Use \`/afk\` or \`${prefix}afk\` with or without a reason`;
    ...
    // BOTINFO - Interactive 3-page system with buttons
    // Page 1: Main | Page 2: Full Description | Page 3: Commands Guide
...
client.on(Events.MessageCreate, async msg => {
    ...
    if (msg.content.startsWith(prefix)) {
        ...
        if (cmd === 'bkl') {
            ...
            try {
                // 1. Delete the input message immediately
                ...
                // 3. Send confirmation message immediately
                ...
                // 4-5. Delete messages in background (don't await - fire and forget)
                (async () => {
                    try {
