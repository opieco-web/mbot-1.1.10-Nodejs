...
const welcomeMessages = [
    ...
    "Glad to have you with us. Feel free to explore.",
    "Welcome! Make yourself comfortable and say hi anytime.",
    "Nice to see you here — enjoy your stay!",
    "Hey, welcome! Hope this place feels like home soon.",
    "Happy to have you here. Join the conversations!",
    "Welcome! We're glad you joined us today.",
    "Great to see you! Hope you enjoy the server.",
    "Welcome to the community! We're happy you're here.",
    "Glad you joined! Feel free to look around.",
    "স্বাগতম! আশা করি এখানে তোমার ভালো লাগবে।",
    "ভালো লাগলো তুমি যোগ দিলে — আরাম করে থাকো।",
    "স্বাগতম! নিজের মতো করে server explore করতে পারো।",
    "এলে ভালো হলো — আশা করি সময়টা enjoy করবে।",
    "স্বাগতম! এখানে সবাই বেশ friendly.",
    "Welcome! Take your time and enjoy the vibe.",
    "Nice to meet you here — hope you have fun.",
    "Welcome! Join whenever you're comfortable.",
    "Happy you joined! Feel free to connect with others.",
    "Welcome on board! Wishing you a good experience here.",
    "Ei server e tomake স্বাগতম — enjoy your time.",
    "Welcome bro! Feel free to chill around.",
    "Good to have you here — hope you like the environment.",
    "Welcome! You're always free to join any chat.",
    "Hello! Thanks for joining us today.",
    "স্বাগতম! তোমার সাথে পরিচয় ভালো লাগলো।",
    "Glad you're here! Stay as long as you like.",
    "Welcome! Hope your time here is enjoyable.",
    "Nice to see you! Take it easy and relax.",
    "Welcome! Feel free to express yourself here.",
    "Hey! Glad you joined us — have fun!",
    "স্বাগতম! চাইলে সবাইকে হাই বলতে পারো।",
    "Welcome! Hope you meet great people here.",
    "Happy to see you! Enjoy the space.",
    "Welcome to the group — always open for conversation.",
    "Hey, welcome! Good to have you with us.",
    "Glad you're here! Let's make it a good experience.",
    "Welcome! You're always welcome to join the flow.",
    "স্বাগতম! সার্ভারটা explore করে দেখো।",
    "Welcome! Feel free to settle in.",
    "Nice to have you here — hope you enjoy your time."
];
